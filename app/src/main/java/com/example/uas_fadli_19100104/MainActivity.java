...
public class MainActivity<MINUTE> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemListView=findViewById(R.id.list_item);
    ...
    //mengatur notifikasi
    private void scheduleNotification(Notification notification, String delay){
        ...
        if (alarmManager!=null){
            alarmManager.set(AlarmManager.RTC_WAKEUP, Long.parseLong(delay),pendingIntent);
        }
    }
    private Notification getNotification(String content){

        //saat notifikasi diklk di arahkan ke MainActivity
    ...
    private void insertDataToDb(String title, String date, String time){
        ...
        if(insertData){
            ...
            toastMsg("Opps.. terjadi kesaahan saat menyimpan");
    }
    ...
    private void showAddDialog(){
        ...
        final EditText judul=dialogView.findViewById(R.id.edit_query);
        ...
        String dateString=dataSdf.format(String.valueOf(date));
                                         ...
                                         TimePickerDialog timePickerDialog=new TimePickerDialog(getLayoutInflater().getContext(),
                                                 new TimePickerDialog.OnTimeSetListener() {
                                                     ...
                                                     public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                                         ...
                                                         Log.d(TAG, "onTimeSet:Time has been set succesfully");
                                                     }
                                                 },cal.get(Calendar.HOUR),cal.get((Integer) MINUTE),false);
